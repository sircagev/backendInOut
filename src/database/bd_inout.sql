...
DELIMITER //
CREATE TRIGGER before_elemento_update
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` TRIGGER `movement_details_BEFORE_INSERT` 
BEFORE INSERT ON `movement_details` FOR EACH ROW 
BEGIN
